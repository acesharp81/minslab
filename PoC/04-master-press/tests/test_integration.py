...
class MainIntegrationTests(unittest.TestCase):
    def test_static_dashboard_and_project_registration(self):
        ...
        self.assertEqual(body.count(b'<script src="/poc/master-press/app.js?v=20260721-19"></script>'), 1)
        ...
        self.assertIn(b'class="nav manual-download"', body)
        ...
        self.assertIn("제목, 담당과, 담당자 이름".encode("utf-8"), body)
