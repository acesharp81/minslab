...
export declare class RhwpEditor {
  ...
  /** 현재 네이티브 편집기의 텍스트 선택을 반환합니다 */
  getSelectionText(): Promise<{ text: string; hasSelection: boolean }>;
  /** 현재 네이티브 선택을 한 번의 Undo 가능한 편집으로 교체합니다 */
  replaceSelection(text: string): Promise<{ ok: true }>;
  /** iframe 엘리먼트를 반환합니다 */
